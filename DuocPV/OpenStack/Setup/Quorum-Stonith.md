# Tổng quan về Quuorum,Stonith/Fencing. 
## Tổn quan về Quuorum 
### Định nghĩa
...
![Atom](https://i.imgur.com/ka27TPS.png)
...
![Atom](https://i.imgur.com/JjMXhok.png)

- Trong trường hợp cluster gồm 6 node bị phân mảnh thì cần ít nhất 4 node cùng hoạt động trong cluster để hình thành quorum. Trong trường hợp bị phân mảnh nhỏ hơn pacemaker sẽ cô lập hoặc ngừng cung cấp dịch vụ.[Atom](https://i.imgur.com/xEgvwpi.png)
![Atom](https://i.imgur.com/xEgvwpi.png)
...
![Atom](https://i.imgur.com/EZoaIxM.png)