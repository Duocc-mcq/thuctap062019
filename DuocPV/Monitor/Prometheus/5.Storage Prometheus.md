...
- Để tìm hiểu thêm chi tiết về cấu trúc các file, xem tại đây
...
- Thông tin về cấu hình tích hợp remote storage trong Prometheus xem tại remote write và remote read
...
- Để tìm hiểu thêm về tích hợp hiện có với các hệ thống lưu trữ từ xa, xem thêm tại Integrations documentation
